...
from available_apis.browser_tools.return_dict import BROWSER_FUNCTION_DOCUMENTATION_DICT, BROSWER_FUNCTION_DICT
...
def merge_browser_functions():
    ...
    FUNCTION_APIS_FUNCTION_DICT.update(BROSWER_FUNCTION_DICT)
...
class LocalTranslatorNode(BaseNode):
    ...
    def prepare_input_for_api_running_step(self, step, api_documentation):
        ...
        input_string += f"\n- Panel Description: {self.panel_description}\n"
