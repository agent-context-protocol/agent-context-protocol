...
from available_tools.browser_tools.return_dict import BROWSER_FUNCTION_DOCUMENTATION_DICT, BROSWER_FUNCTION_REQD_PARAMS_DICT, BROSWER_FUNCTION_PARAMS_DICT
...
def merge_browser_functions():
    ...
    FUNCTION_TOOLS_REQD_PARAMS_DICT.update(BROSWER_FUNCTION_REQD_PARAMS_DICT)
    FUNCTION_TOOLS_PARAMS_DICT.update(BROSWER_FUNCTION_PARAMS_DICT)
...
class DAGCompilerNode(BaseNode):
    ...
    def parse_dag_compiler_execution_blueprint(self, text, restrict_one_group = False, modified_execution_blueprint_bool = False):
        ...
        execution_blueprints = {"user_query": self.query}
    ...
    def create_first_input_data(self,query, subtask_list):
        ...
        self.subtask_details = formatted_string
    ...
    def setup(self, query, subtask_list):
        ...
        event = {
            ...
            "description": "ProtocolCompositionStarted"
        }
        BaseNode.events.append(event)

        self.query = query
        self.subtask_list = subtask_list
        # Logic to create execution blueprint and initialize agent instances
        ...
        # generating the execution blueprint from the LLM
        ...
        run_success = False
        counter = 0
        while not run_success and counter < 7:
            try:
    ...
    async def communicate(self, update, agent_id, agent_object):
        ...
        event = {
            "timestamp": now + "Z",  # E.g. "2025-03-24T14:55:00.123456Z"
            "description": "ExecutionBlueprintModificationRequest"
        }
        BaseNode.events.append(event)
    ...
    async def process_queue(self):
        while True:
            ...
            if parsed_updated_execution_blueprint['chosen_action'] == "DROP_SUBTASK":
                ...
                print('Sent Request to Drop subtask')
