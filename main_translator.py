...
from available_apis.browser_tools.return_dict import BROWSER_FUNCTION_DOCUMENTATION_DICT, BROSWER_FUNCTION_REQD_PARAMS_DICT, BROSWER_FUNCTION_PARAMS_DICT
...
def merge_browser_functions():
    ...
    FUNCTION_APIS_DOCUMENTATION_DICT.update(BROWSER_FUNCTION_DOCUMENTATION_DICT)
    FUNCTION_APIS_REQD_PARAMS_DICT.update(BROSWER_FUNCTION_REQD_PARAMS_DICT)
    FUNCTION_APIS_PARAMS_DICT.update(BROSWER_FUNCTION_PARAMS_DICT)
...
class MainTranslatorNode(BaseNode):
    ...
    def parse_main_translator_workflow(self, text, restrict_one_group = False, modified_workflow_bool = False):
        ...
        workflows = {"user_query": self.query}
    ...
    def create_first_input_data(self,query, panels_list):
        ...
        self.panel_details = formatted_string
